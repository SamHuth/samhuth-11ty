...
[ooh.directory](https://ooh.directory){target="_blank"}
[Damaged Earth Catalogue](https://damaged.bleu255.com){target="_blank"}
[The way of code](https://www.thewayofcode.com){target="_blank"}
[10k Drum Machines](https://10kdrummachines.com){target="_blank"}
[verses.xyz](https://verses.xyz){target="_blank"}
[permacomputing](https://permacomputing.net){target="_blank"}
[The web is fast by default, let’s keep it fast](https://hidde.blog/the-web-is-fast-by-default-lets-keep-it-fast){target="_blank"}
[Classic Websites](https://bsky.app/profile/classicweb.site){target="_blank"}
[Slash Pages](https://slashpages.net/){target="_blank"}
[Choo Choo World](https://choochooworld.com/){target="_blank"}
